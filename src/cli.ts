...
function cliOptions() {
  return {
    ...
    derivedOutputPath: {
      type: "string",
      alias: "do",
      default: path.resolve(process.cwd(), "generated/derived.ts"),
      description:
        "The file path to write the generated derived tokens file to. " +
        "Holds text and effect styles that reference theme tokens.",
    },
    themeOutputFolder: {
      type: "string",
      alias: "to",
